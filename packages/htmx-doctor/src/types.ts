...
export interface ProjectInfo {
  ...
  htmxVersion: string | null;
  framework: Framework;
  hasTypeScript: boolean;
  sourceFileCount: number;
  htmxSourceFileCount: number;
}
...
export interface HtmxDoctorIgnoreConfig {
  rules?: string[];
  files?: string[];
}

export interface HtmxDoctorConfig {
  ignore?: HtmxDoctorIgnoreConfig;
  lint?: boolean;
  deadCode?: boolean;
  verbose?: boolean;
  diff?: boolean | string;
